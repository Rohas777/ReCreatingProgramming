...
public:
	...
	void update(float time) {
		...
		if (onGround == true) {
			...
			{
				if (int(CharacterCurrentFrame) == 0) sprite.setTextureRect(IntRect(0, 0, 45, 58)); 
				if (int(CharacterCurrentFrame) == 1) sprite.setTextureRect(IntRect(46, 0, 46, 58)); 
				if (int(CharacterCurrentFrame) == 2) sprite.setTextureRect(IntRect(93, 0, 55, 58)); 
			}
			if (dx < 0) // Движение влево
			{
				if (int(CharacterCurrentFrame) == 0) sprite.setTextureRect(IntRect(46, 0, -45, 58)); 
				if (int(CharacterCurrentFrame) == 1) sprite.setTextureRect(IntRect(93, 0, -46, 58)); 
				if (int(CharacterCurrentFrame) == 2) sprite.setTextureRect(IntRect(148, 0, -55, 58)); 
			}
		}
